...
OPERATION_NOT_PERMITTED = "operation not permitted for provided permissions"

INTERNAL_ERROR_MESSAGE = "happened something unexpected. please ask support for help"
